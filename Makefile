...
dropdb:
	docker exec -it postgres12 dropdb udemy
...
migratedown:
	migrate -path db/migration -database "postgresql://root:secret@localhost:5432/udemy?search_path=simple_bank&sslmode=disable" -verbose down
